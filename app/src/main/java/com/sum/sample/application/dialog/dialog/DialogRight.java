 ...
 * Desc:
 */
public class DialogRight  extends AlertDialog {
    private Context context;
    public DialogRight(@NonNull Context context) {
        super(context);
        this.context = context;
    }

    public DialogRight(@NonNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置沉浸式
        ImmersionBar.with((Activity) context, DialogRight.this)
