package com.sum.sample.base.widget.smooth_material;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#f32d2e");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, WorkUtils.dip2px(0));
        ta.recycle();
    ...
    public void setCheckedNoEvent(boolean checked, boolean animate) {
        if (animate) {
            mTickDrawing = false;
            mChecked = checked;
            mDrewDistance = 0f;
            ...
            this.setCheckedNoEvent(checked);
        }
    }
    ...
    private int measureSize(int measureSpec) {
        int defSize = WorkUtils.dip2px(DEF_DRAW_SIZE);
