...
//        backgroundColor = getResources().getColor(R.color.app2_blue2);
//        borderColor = getResources().getColor(R.color.app2_blue2);
        ...
        paintCenter.setColor(borderColor);
