 ...
 * Desc: 悬浮按钮-可拖拽
 */
public class DragFloatingView extends DragView {
    ...
    public DragFloatingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public DragFloatingView(Context context, AttributeSet attrs, int defStyleAttr) {
